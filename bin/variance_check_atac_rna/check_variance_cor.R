...
png('norm_compare/rna_scatterplot.png')
par(mfrow=c(2,2))
heatscatter(data_rna_sig[,1], data_rna_sig[,2], pch = 20, xlim=c(-5, 20), ylim=c(-5, 20))
abline(0,1, col='black')
heatscatter(data_rna_sig[,1], data_rna_sig[,3], pch = 20, xlim=c(-5, 20), ylim=c(-5, 20))
abline(0,1, col='black')
heatscatter(data_rna_sig[,1], data_rna_sig[,4], pch = 20, xlim=c(-5, 20), ylim=c(-5, 20))
abline(0,1, col='black')
heatscatter(data_rna_sig[,1], data_rna_sig[,5], pch = 20, xlim=c(-5, 20), ylim=c(-5, 20))
abline(0,1, col='black')
dev.off()
...
data_atac_sig_log2_tr = log2((data_atac_sig_tr+1)/10000*1000)
data_atac_sig_log2_tr_1mb = log2((data_atac_sig_tr_1mb+1)/10000*1000)
data_atac_sig_log2_tr_1kb = log2((data_atac_sig_tr_1kb+1)/1000*1000)
data_atac_sig_log2_tr_5kb = log2((data_atac_sig_tr_5kb+1)/5000*1000)
data_atac_sig_log2_tr_10kb = log2((data_atac_sig_tr_10kb+1)/10000*1000)
...
for (method in c('pearson', 'spearman')){
	...
	print(head(data_atac_rna_sig_cor))
	print(head(as.logical((data_atac_rna_sig_cor<=(-0.4)) * (data_atac_rna_sig_cor>=(-0.6)))))
	...
	dev.off()
	print(head(data_atac_sig_log2[as.logical((data_atac_rna_sig_cor<=(-0.4)) * (data_atac_rna_sig_cor>=(-0.6))), ]))
	print(head(data_rna_sig[as.logical((data_atac_rna_sig_cor<=(-0.4)) * (data_atac_rna_sig_cor>=(-0.6))), ]))
	...
	#print(dim(data_atac_sig_sf_log2_110))
	#print(data_atac_sig_sf_log2_110[1,])
	#print(data_atac_sig_sf_log2_110[sample(nrow(data_atac_sig_sf_log2_110)),][1,])

	#print(data_atac_sig_sf_am_log2_110[1,])
	#print(data_atac_sig_sf_am_log2_110[sample(nrow(data_atac_sig_sf_am_log2_110)),][1,])

	#print(data_rna_sig[1,])
	#print(head(data_atac_sig_sf_log2_110))
	#print(head(data_atac_sig_sf_log2_110[sample(nrow(data_atac_sig_sf_log2_110)),]))
